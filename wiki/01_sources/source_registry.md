...
## Purpose
This page tracks all source notes currently known to the wiki.
...
| source_id | title_en | source_type | source_status | languages | domains | linked_pages | notes |
|---|---|---|---|---|---|---|---|
...
| [[SRC-PG-PRODUCT-SHEET-EN]] | PG Product Sheet EN | product_fact_source | pending_confirmation | en | product, marketing |  | source note created; extraction limited, no facts promoted |
...
- source notes must be created before downstream wiki facts are normalized
- source registry should be updated whenever a new source note is added
