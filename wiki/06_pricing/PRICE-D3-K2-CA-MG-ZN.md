---
id: PRICE-D3-K2-CA-MG-ZN
title_en: D3 + K2 + Calcium + Magnesium + Zinc Price Evidence
title_zh: 五合一维骨力价格证据
page_type: pricing
...
source_ids: [SRC-WIDE-BONE-CN-CARD]
source_files:
...
tags: [pricing, wide-naturals, bone-health, livestream, source-linked, native-review]
---

# D3 + K2 + Calcium + Magnesium + Zinc Price Evidence
...
- No official current price is finalized from this source.
- No current working price snapshot is available from the evidence below.
- The card contains undated or loosely dated price evidence, including a chart labeled "2026款比价图".
- Treat every price below as non-current source evidence only, not timeless quotation logic.
- All listed prices remain `pending_confirmation` until exact observation date, channel, package size, campaign period, currency, and shipping context are freshly verified.
...
- Retail price: 90 tablets x 1 bottle is shown as ¥298 in multiple source-card contexts.
- [[TERM-LIVESTREAM-PRICE|Livestream price]]: 90 tablets x 1 bottle is shown as ¥179 in the main card block.
- Promotion price: Tmall 120 tablets x 1 bottle is shown as ¥258 in the comparison chart; this is a different pack size.
- Platform-specific variance: source references Douyin, Kuaishou, Tmall, and Amazon Canada comparison.
- Campaign notes: no exact observation date, campaign date, or validity period is stated.

## Guardrails
- Do not treat undated pricing as current truth.
- Do not merge platform prices into one official price without policy confirmation.
- Do not quote the Amazon comparison as a local sale price; the source states it excludes shipping.
- Do not use any row above as a customer quote while `date_observed` is `not stated` or `2026 label only`.
- Any customer-facing pricing statement requires fresh verification.

## Customer-Facing Reply Notes
### English
native_review_required: true

Do not provide a customer-facing price from this page without checking the current channel, package size, campaign period, currency, and shipping context.

### 中文内部说明
本页仅保存手卡中的价格证据。由于缺少明确日期、活动周期和渠道规则，不能直接作为报价或客服回复价格。

## Open Questions
- 直播价是否仅适用于指定平台、主播、日期或组合装？
- "2026款比价图" 的实际采集日期是什么？
- 天猫 120 粒/瓶活动价是否对应同一配方与同一产品版本？
- 是否存在公司批准的渠道报价规则？

## Graph Links
- Source note: [[SRC-WIDE-BONE-CN-CARD]]
- Product page: [[PROD-D3-K2-CA-MG-ZN]]
- Pricing term: [[TERM-LIVESTREAM-PRICE]]
- Related review-sensitive terms on the product page: [[TERM-NPN]], [[TERM-SUGGESTED-USE]]

## Source Map
- [[SRC-WIDE-BONE-CN-CARD]]: WideNaturals加拿大五合一维骨力头部手卡.pptx
- Related product page: [[PROD-D3-K2-CA-MG-ZN]]
- Related term page: [[TERM-LIVESTREAM-PRICE]]
